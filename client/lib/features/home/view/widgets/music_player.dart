...
import 'package:client/features/home/view/widgets/audio_slider.dart';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            Color(int.parse('0xFF${currentSong!.hex_code}')),
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Column(
                        children: [
                          AudioSlider(
                            position:
                                position, // La variable de posición que ya tienes en tu vista
                            duration:
                                duration, // La variable de duración que ya tienes en tu vista
